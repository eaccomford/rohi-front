          ...
          <header className="sticky top-0 z-50 grid grid-cols-3 p-5 shadow-md bg-white-100/60 md:px-10 backdrop-blur-sm">
            ...
            <div className="xflex">
                <Image
                  ...
                  objectPosition="left"
                />
                 <div className="ml-[40px] hidden md:flex  text-white">The Rohi Church</div>
              </div>
            </div>
            {/* search */}
              ...
              <div className="flex justify-between inline-block w-[500px] p-2 text-center text-white hidden md:flex">
                <Link href={`/sermons`}>
                  <div className="flex h-3">
                    <div className="mb-2 cursor-pointer hover:border-t-2">About</div>
                  </div>
                </Link>
                <Link href={`/sermons`}>
                  <div className="flex h-3">
                    <div className="mb-2 cursor-pointer hover:border-t-2">Contact</div>
                  </div>
                </Link>
                <Link href={`/sermons`}>
                  <div className="flex h-3">
                    <div className="mb-2 cursor-pointer hover:border-t-2">Sermons</div>
                  </div>
                </Link>
                <Link href={`/sermons`}>
                  <div className="flex h-3">
                    <div className="mb-2 cursor-pointer hover:border-t-2">Events</div>
                  </div>
                </Link>
                <Link href={`/sermons`}>
                  <div className="flex h-3">
                    <div className="mb-2 cursor-pointer hover:border-t-2">Services</div>
                  </div>
                </Link>
                <Link href={`/donation`}>
                  <div className="flex h-3">
                    <div className="mb-2 cursor-pointer hover:border-t-2">Donations</div>
                  </div>
                </Link>
              </div>
            </div>
