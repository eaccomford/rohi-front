      ...
      <main className="px-8 mx-auto md:px-50 md:mx-20 md:px-[0em]">
        <div className="grid grid-cols-1 mb-5 sm:grid-cols-6 lg:grid-cols-6 ">
          ...
          <div className="hidden sm:pr-3 sm:block">
            <div className="mt-2 bg-gray-100 rounded-2xl">
              ...
              {loginClicked ? (
                <>
                  <div
                    onClick={() => toggleMenu('momo')}
                    className="py-3 pl-4 cursor-pointer hover:bg-gray-200 hover:transition-all hover:duration-600"
                  >
                  ...
                  <div
                    onClick={() => toggleMenu('paymentHistory')}
                    className="py-3 pl-4 cursor-pointer hover:bg-gray-200 hover:transition-all hover:duration-600"
                  >
                    <div className="flex justify-between text-sm rounded">
                      <div className="flex">
              ...
              <div
                onClick={() => toggleMenu('successStory')}
                className="py-3 pl-4 cursor-pointer hover:bg-gray-200 hover:transition-all hover:duration-600"
              >
                <div className="flex justify-between text-sm rounded">
                  <div className="flex">
          ...
          <div className="grid col-span-3 pb-3 mb-3 md:border-l md:border-r md:px-3">
            ...
            {toggleMenuState == 'whywegive' && (
              <WhyWeGive fetchedData={fetchedData} />
            )}
